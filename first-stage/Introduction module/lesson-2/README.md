...
1. Клавиша `F5` (будьте внимательны, на некоторых ноутбуках может потребоваться дополнительно зажать кнопку `fn`)
...
Отлично, тут можно развить тему, спросите их как они задавали направление движения главного героя вниз (делали гравитацию). Выведите их снова на векторы и переменные. Спросите могут ли они что-то взять из кода главного героя, чтобы дать это противнику.
