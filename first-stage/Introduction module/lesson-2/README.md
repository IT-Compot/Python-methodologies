...
Во время рисования, объясняете детям пошагово. Как можно через координаты, определить насколько далеко находятся друг от друга персонаж и противник. Расскажите про разность координат. Отметьте, что `x` отнимается от `x`, а `y` от `y`. Можно даже в 2-х словах обмолвиться о тереме пифагора и показать формулу. 
...
- Покажите [презентации](ссылка-на-презу) и расскажитье о следующих проектах (вставить задел на следующий урок)
