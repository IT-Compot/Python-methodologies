...
Тут хорошо будет объяснить, что вообще такое [вектор](https://docs.godotengine.org/en/stable/tutorials/math/vector_math.html#coordinate-systems-2d) и чем он отличается от `отрезка`. Отлично будет показать в рисунках.
