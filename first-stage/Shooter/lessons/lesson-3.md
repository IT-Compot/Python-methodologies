...
>[!CAUTION]
>Если дети и/или вы заметили, что враги при приблежении к игроку будто бы "прилпают" к игроку, то стоит переключить параметр в корневом узле бота:<br> <img src='https://github.com/IT-Compot/Python-methodologies/blob/main/first-stage/Shooter/images/FloatingModeGodot.jpg'>
