...
>[!CAUTION]
>Если дети и/или вы заметили, что враги при приблежении к игроку будто бы "прилпают" к игроку, то стоит отключить следующие слои в корневом узле бота:<br> <img src='https://github.com/IT-Compot/Python-methodologies/blob/main/first-stage/Shooter/images/floor_mask_enemy.png'>
