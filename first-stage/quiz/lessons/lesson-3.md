...
Теперь после всех этих корректировок, можем полностью проверять игру.

# Итоги
1) Работающие механики победы и поражения
2) В игру теперь можно играть бесконечно
3) Улучшенные навыки работы с массивом
