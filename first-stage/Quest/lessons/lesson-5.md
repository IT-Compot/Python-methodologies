...
# Содержание
- [Программируем интерфейс](#программируем-интерфейс)
- [Интерфейс со списком квестов](#интерфейс-со-списком-квестов)
	- [Интерфейс со списком квестов](#интерфейс-со-списком-квестов)
	- [Скрипт списка квестов](#скрипт-списка-квестов) 
- [Программируем интерфейс квестгивера](#интерфейс-квестгивера)
- [Небольшая памятка по работе методов массивов](#методы-для-работы-с-массивами)
- [Создаем предмет для квеста](#создание-предмета-для-квеста)
	- [Скрипт предмета для квеста](#скрипт-предмета-для-квеста) 
- [Создание узла для предметов](#создание-узла-для-предметов)
- [Итоги](#итоги)
...
- На этом уроке ученики комплексно поработали с интерфейсами, программировали их.
- Создали предметы для квеста, в принципе сами квесты, которые работают
