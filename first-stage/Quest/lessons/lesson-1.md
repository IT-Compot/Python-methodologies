...
## Цель урока
Используя навыки полученные на проектах "Платформер 2д" и "Шутер", создать анимированного персонажа способного перемещаться по карте.
...
- Знакомство с нормализцией векторной скорости.
