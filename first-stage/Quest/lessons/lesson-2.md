...
![image](https://github.com/user-attachments/assets/058392de-90cf-491f-932b-b1ba6244589a)
...
Прикрепляем скрипт и добавляем сигналы от родительского узла.
...
Основным узлом будет `Control`. Переименуйте его и присоединяйте следующие узлы:
* `Panel` 3 штуки
...
>[!tip]Ты можешь спросить у детей: "Как сделать так, чтобы бот всегда отвечал по-разному на один и тот же вопрос?"
