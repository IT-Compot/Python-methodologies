...
Подготавливаем нашу IDE Pycharm Community Edition

Выбираем новый проект. Название задаем проекта задаем там, где написана цифра 1. Также проверем необходимую версию Python (3.10 - 3.12).
