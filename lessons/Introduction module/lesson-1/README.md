...
Если ученик опоздал на урок, обязательно поприветствовать. Задать 2 простых впроса (сколько лет, где живёшь, опыт программирования). Ученика необходимо влить в группу \
...
> Все уроки первого года ведём 3.x.x версии!

**[актуальная версия движка](https://godotengine.org/download/3.x/windows/)**
...
После этого запускаем игру `F5` или клавишей ![alt text](image-11.png)справа сверху и смотрим, что вышло.
...
Сбрасываем позицию `спрайта` и группируем объекты при помощи кнопки на панели инструментов ![alt text](image-13.png).\
